      ...
      <div class="app-container">
        ...
        <div class="app-hero-header">
          ...
          <div>
            ...
            <h3 class="fw-light">
              <span>Home</span> / <span class="menu-text">Allowance List</span>
            </h3>
          </div>
          <!-- Page Title end -->
                    ...
                    <thead>
                      ...
                      <?php
                            ...
                            while ($row = $query->fetch_assoc()) {
                                ...
                                <tr>
                                    <td>" . $counter++ . "</td> 
                                    <td>" . ucwords($row['allowance']) . "</td>
                                    <td>" . $row['allowance_type'] . "</td>
                                    <td>" . number_format($row['amount'], 2) . "</td>
                                    <td>
                                        <button class='btn btn-success btn-sm edit btn-flat' data-id='" . $row['allowid'] . "'>
                                            <i class='bi bi-pencil'></i>
                                        </button>
                                        <button class='btn btn-danger btn-sm delete btn-flat' data-id='" . $row['allowid'] . "'>
    ...
    function getRow(id) {
      $.ajax({
        ...
        success: function (response) {
          ...
          $('#allid').val(response.allowid );
          $('#allow').val(response.allowance);
          $('#frequency').val(response.allowance_type);
          $('#amount').val(response.amount);
          $('#description').val(response.description);
          $('#del_al').val(response.allowid);
          $('#del_allow').html(response.allowance);
