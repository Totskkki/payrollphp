      ...
      <div class="app-container">
        ...
        <div class="app-hero-header">
          ...
          <div>
            ...
            <h3 class="fw-light">
              <span>Home</span> / <span class="menu-text">Allowance Reports</span>
            </h3>
          </div>
          <!-- Page Title end -->
                ...
                <div class="card-body">
                  ...
                  <table id="13monthpay" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT de.*, allowance.*, d.*, p.*, dep.*, e.*, CONCAT(e.first_name, ' ', e.middle_name, ' ', e.last_name, ' ', e.name_extension) AS `full_name` 
                                  FROM allowances_employee d
                                  JOIN employee e ON e.employee_id = d.employee_id
                                  JOIN employee_details de ON de.employee_id = e.employee_id
                                  JOIN allowance  ON allowance.allowid  = d.allempid 
