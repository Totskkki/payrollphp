                ...
                <div class="card-body">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="text" class="form-control attendance_date "  name="attendance_date">
                    </div>
                    <div class="col-md-2">
                      <label>&nbsp;</label>
              ...
              $.each(response, function(index, row) {
                ...
                tbody.append(`
                            <tr>
                                ...
                                <td>
                                <button class="btn btn-success btn-sm edit" data-id="${row.attendance_record ? row.attendance_record.attendanceid : ''}"><i class="fa fa-edit"></i></button>
                                    <button class="btn btn-danger btn-sm delete" data-id="${row.attendance_record ? row.attendance_record.attendanceid : ''}"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                        `);
              });
