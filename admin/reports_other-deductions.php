            ...
            <div class="app-container">
                ...
                <div class="app-hero-header">
                    ...
                    <div>
                        ...
                        <h3 class="fw-light">
                            <span>Home</span> / <span class="menu-text">Other Deductions Reports</span>
                        </h3>
                    </div>
                    <!-- Page Title end -->
                        ...
                        <div class="col-sm-12">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Other Deductions Reports</h5>
                                ...
                                <form method="GET" action="">
                                    ...
                                    <table id="13monthpay" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT de.*, deductions.*, d.*, p.*, dep.*, e.*, CONCAT(e.first_name, ' ', e.middle_name, ' ', e.last_name, ' ', e.name_extension) AS `full_name` 
                                            FROM deductions_employees d
                                            JOIN employee e ON e.employee_id = d.employee_id
                                            JOIN employee_details de ON de.employee_id = e.employee_id
                                            JOIN deductions  ON deductions.dedID  = d.deducid 
                                            ...
                                            if ($bonusPeriodFilter) {
                                                $sql .= " AND DATE_FORMAT(d.created_on, '%Y-%m') = '$bonusPeriodFilter'";
                                            }

                                            $sql .= " ORDER BY d.deductionid  DESC";
